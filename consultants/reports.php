            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div href="#" class="d-sm-flex col-12 align-items-center justify-content-between mb-4">
                        Welcome <?php echo $_SESSION['consultantName'] ?></div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
