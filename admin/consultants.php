                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered table-stripped">
                                    ...
                                    <?php
                                        ...
                                        $consultants = mysqli_query($con,"SELECT Consultants.service_id,Consultants.id,Consultants.firstname,Consultants.lastname,Consultants.gender, Consultants.email, Consultants.address,Consultants.phone,services.name FROM Consultants INNER JOIN services ON services.id=Consultants.service_id");
